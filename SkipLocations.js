...
if(cachable&&(post_cache.length<1)){post_cache[post_cache.length]=method;return;}
...
request.open('POST','https://faptitans.com/api/',false);
...
post((new kill).set_chest((i>boss_chest_start+25)&&((i%5)==0)&&(j>25)),true);await new Promise(r => setTimeout(r, 150));

post((new climb).set_id(i+1),i>25);await new Promise(r => setTimeout(r, 150));
